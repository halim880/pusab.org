            ...
            <div class="col-md-9">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <a class="btn btn-sm mx-2 btn-primary" href="{{route('members.edit', $member->id)}}">Edit</a>
                            @if ($member->hasRole('admin'))
                                <a class="btn btn-sm mx-2 btn-danger" href="{{url('roles/revoke/'.$member->id.'?role=admin')}}">Revoke admin</a>
                            @else
                                <a class="btn btn-sm mx-2 btn-info" href="{{url('roles/assign/'.$member->id.'?role=admin')}}">Make admin</a>
                            @endif
                            @if ($member->hasRole('executive'))
                                <a class="btn btn-sm mx-2 btn-warning" href="{{url('roles/revoke/'.$member->id.'?role=executive')}}">revoke executive</a>
                            @else
                                <a class="btn btn-sm mx-2 btn-primary" href="{{url('roles/assign/'.$member->id.'?role=executive')}}">Make executive</a>
                            @endif
                        </div>
                    </div>
                </div>
